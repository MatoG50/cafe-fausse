      ...
      <div className="relative w-full min-h-screen">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-8 px-4">
          ...
          <div className="text-center text-white">
            ...
            <p className="mt-3 sm:mt-4 text-base sm:text-lg md:text-2xl drop-shadow-lg max-w-md mx-auto">
              Fresh Brews · Cozy Vibes · Great Conversations
            </p>
            <button
              className="mt-4 px-5 py-2 sm:px-6 sm:py-3 bg-black/60 hover:bg-black/80 rounded-xl backdrop-blur-sm text-white text-sm sm:text-base cursor-pointer"
